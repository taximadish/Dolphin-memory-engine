...
std::vector<std::string> StoredItems::customSplit(std::string s, std::string delim)
{
...
std::map<std::string, int8_t> StoredItems::itemCounts(std::string itemsString)
{
  std::vector<std::string> items = StoredItems::customSplit(itemsString, ",");
